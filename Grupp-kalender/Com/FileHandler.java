...
* This class is responsible for handling the filewriting and filereading for the whole application. This class is only used by 
* eventManager only. It contains two simple methods which is writing to a file and reading from a file. 
* @author Akar
* @version 1.0
*/
...
{
    /*
* Method writeFile: Accepts a eventList as a parameter as the object that is going to be written to a file named "events.sav". 
* @param eventList
*/
   ...
   /*
* Method readFile: this method reads the file that is written by the "writeFile" method. It returns the eventList that is written to the
* "events.sav" file. 
* 
*/
