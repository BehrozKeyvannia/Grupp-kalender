...
public class EventManager extends Observable {
	...
	/**
	* Sorts all events in Eventlist in chronlogical order.
	*/
	...
	/**
	 *
	 * Adds a event if it isn't already in eventList and adds the event in all the participants list in hMap. Notifies Observers
	 * @param event
	...
	/**
	 * Searches for an Event in eventList and returnes the event with the specified hashCode
	 * @param hashCode hashCode to be searched
	...
	/**
	 * Searches through a list(param) for a Event with the specified hashCode(param)
	 * @param list List to be searched
	 * @param hashCode hashCode to search after.
	 * 
	...
	/**
	 * Removes the EventReference with the specified hashCode in a user list and removes the users name in the event's userNames.
	 * @param user user to remove
	 * @param hashCode Events hashcode which the user is removed from.
	 * 
	 */
	...
	/**
	 * Removes all users from the event (using removeUserFromEvent method) and then removes/deletes the Event. Notifies Observers
	 * @param The Event's hashCode to be removed
	 */
	...
	public void saveEvents()
    {
    	...
    	/**
    	 * Reads from local Event.sav file and adds all events that are not already there. If it doesn't exist throws/catches IOexception
    	 * Is only called once during initation in constuctor.
    	 */
