...
/**
 * Represents a singular event and contains info of the event and the users
 * attending the event.
 * 
...
public class Event implements Comparable<Event>, Serializable {
	...
	/**
	 * Create an event with parameter values. Formats the yyyy-MM-dd date and
	 * HH:mm startTime as a Date object.
	 * 
	 * @param userName
	 * @param title
	 * @param date
	...
	/**
	 * Create a String array of the userNames splitted by comma ',' and returns
	 * it
	 */
	...
	/**
	 * Returns the string array provided by 'getListOfUsers' method as a
	 * Arraylist
	 */
	...
	/**
	 * Returns a String with HTML code for JComponents. /n doesnt work with
	 * JComponents. Instead we use <br />
	 */
	...
	/**
	 * Compares current and parameter Event by Dates. If o is past <0 is
	 * returned. If o is equal 0 is returned. If o is future date >0 is
	 * returned.
	 */
	@Override
	...
	@Override
	public int hashCode() {
		return title.hashCode() + date.hashCode() + startTime.hashCode()
				+ endTime.hashCode() + description.hashCode();
	}
	...
	public boolean equals(Object obj) {
		...
		Event rhs = (Event) obj;
		return (title.equals(rhs.title) && date.equals(rhs.date)
				&& startTime.equals(rhs.startTime)
				&& endTime.equals(rhs.endTime) && description
					.equals(rhs.description));
	}
}
